    ...
    return (
        <div className=' w-full mx-auto justify-around ' >
            ...
            <div  >
                ...
                <button onClick={() => setShowConfirm(true)} className="bg-[#FF0000]  text-white disabled:animate-pulse  text-green11 hover:bg-green5 focus:shadow-green7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none focus:shadow-[0_0_0_2px] focus:outline-none">
            ...
            {
                showConfirm &&
                <ConfirmModal message={'¿Seguro que la deseas eliminar?'} onConfirm={handleConfirm} onCancel={handleCancel}></ConfirmModal>
            }
