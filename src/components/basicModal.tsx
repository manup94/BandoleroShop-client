    ...
    return (
        <Dialog.Root open={show} onOpenChange={onOpenClose} >
            <Dialog.Trigger asChild>
                <button onClick={onOpenClose} className=" bg-[#1e293b] text-white bg-green4 disabled:animate-pulse  text-green11 hover:bg-green5 focus:shadow-green7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none focus:shadow-[0_0_0_2px] focus:outline-none">
                    Crear
                </button >
            </Dialog.Trigger>
            <Dialog.Portal>
